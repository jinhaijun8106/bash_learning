...
output_result_defined_file="result_macros_source_defined.txt"
output_result_undefined_file="result_macros_source_undefined.txt"
...
find $source_path -name $source_code_type1 | xargs grep $macro_pattern >> $output_path/$output_raw_file
...
find $source_path -name $source_code_type1 | xargs grep $macro_pattern_undef >> $output_path/$output_raw_file
cp $output_path/$output_raw_file $output_path/$output_sed_file
sed -i 's/:/ /g' $output_path/$output_sed_file
